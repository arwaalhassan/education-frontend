  ...
  return (
    <div className="p-6 bg-white rounded-2xl border border-gray-200 shadow-sm" dir="rtl">
      ...
      <div className="flex bg-gray-100 p-1 rounded-xl mb-6">
        ...
        >
          <LinkIcon size={18} /> إضافة رابط
        </button>
      </div>

      {/* عنوان المادة */}
      <div className="mb-4 text-right">
        <label className="block text-sm font-bold mb-2 text-gray-700">عنوان الدرس / المادة</label>
        <input 
          type="text" 
          value={title} 
          onChange={(e) => setTitle(e.target.value)}
          placeholder="مثلاً: حصة مراجعة مباشرة"
